// last modified on 25/7/24 at 2:30am
...
public class MyTimer : MonoBehaviour
{
    ...
    [Tooltip("Should i respect slowmotion?")]
    ...
    void handleTime(){
        ...
        finalTxt = $"{caption} {outxt} {suffix}";
        cm.seTxt(thetext, finalTxt);
    }

    public void startCounting(){count = true;}
    public void stopCounting(){count = false;}
    public void countme(bool con) {count = con;}
    public void addtime(float amt) {thetime += amt;}
    public void removetime(float amt) {thetime -= thetime >= amt ? amt : thetime;}
